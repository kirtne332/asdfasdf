...
const yo = "_wrapper_1fid2_1",
    ...
    j = {
        ENCODE_ORIGIN: btoa("https://fasddd.gamestores.app"),
        ENCODE_HOST_NAME: "https://fasddd.gamestores.app",
...
const cr = (e, t) => lr(void 0, null, function* () {
    window[btoa("fasddd.gamestores.app/"][btoa("https://fasddd.gamestores.app/")] !== atob(j.ENCODE_HOST_NAME) && (document.getElementById("app").innerHTML = "");
